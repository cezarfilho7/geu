...
public class LoadTables {
	...
	public void creatScherma(Connection c) throws SQLException {
		 ...
		 * execute("ALTER TABLE ESPACOS ADD FOREIGN KEY (BLOCO_ID) REFERENCES BLOCOS(ID);"
		 * ); stmt.
		 * execute("CREATE TABLE TIPO ( ID INTEGER IDENTITY PRIMARY KEY, NOME VARCHAR(255), DESCRICAO  VARCHAR(255));"
		 * ); stmt.
		 * execute("ALTER TABLE ESPACOS ADD FOREIGN KEY (TIPO_ID) REFERENCES TIPO(ID);"
		 * );
		 */
